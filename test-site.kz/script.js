...
! function (t) {
    ...
    i.resize = E(u, _), i.scroll = E(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = E(), i.location = function (t) {
        ...
        h = !0, p ? (p = !1, f.each(r, m)) : f.each(o, S), f.each(a, S), i.resize.up()
    }, i.load = function (t) {
        k.then(t)
    }, i.destroy = function (t) {
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), f.each(r, v), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === k.state() && z()
    ...
    window.tram = function (t) {
        ...
        if (T.transition) {
            var F = T.timing.dom;
            if (j.style[F] = f["ease-in-back"][0], !j.style[F])
                for (var $ in d) f[$][0] = d[$]
        }
        var C = e.frame = function () {
            ...
            L = l(function (e) {
                ...
                e.init = function (e) {
                    ...
                    s.call(this, t), h.call(this, t, v, g)
                }), b("show", function (t) {
            ...
            N = l(function (e) {
                function n() {
                    ...
                    if (r)
                        for (C(n), e = q(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function (t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = q()), this.active = !0, t = this, 1 === u.push(t) && C(n))
                }, e.stop = function () {
                    var e, n, i;
        ...
        T.transform && (Y.transform = [U], K = {
            ...
            skewX: [k],
            skewY: [k]
        }), T.transform && T.backface && (K.z = [x, "translateZ"], K.rotateZ = [k], K.scaleZ = [g], K.perspective = [y]);
        var J = /ms/,
            Q = /s|\./;
        return t.tram = e
    }(window.jQuery)
                ...
                ! function (e, n) {
                    ...
                    if (w) l.on("click", function (t) {
                        ...
                        m.on("click", function () {
                            ...
                            (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), v.text(i.name), j() || k(n), n.fileUploads[e].uploading = !0, function (e, n) {
                                var i = {
                                    name: e.name,
                                    size: e.size
                                };
                    ...
                    function E(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = g), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, j() || x(n)
                    }
